...
const MODE_ACCOUNTS: Record<string, { name: string; icon: string; interval: string; sl: number; tp: number; volMul: number }> = {
  TREND:   { name: "Sanal Kasa - Trend Takipçisi (1d)",   icon: "🐢", interval: "1d",  sl: 2.0, tp: 6.0,  volMul: 2.0 },
  AVCI:    { name: "Sanal Kasa - Avcı (1h)",              icon: "🦅", interval: "1h",  sl: 0.8, tp: 2.5,  volMul: 1.5 },
  SCALPER: { name: "Sanal Kasa - Keskin Nişancı (15m)",   icon: "⚡", interval: "15m", sl: 0.4, tp: 1.2, volMul: 1.2 },
};
